    ...
    <form action={formAction} className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4 shadow-[0_18px_35px_rgba(0,0,0,0.35)]">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="md:col-span-2">
          <label htmlFor="companyName" className="mb-2 block text-sm font-medium text-slate-200">
            Company name
          </label>
          <input
            id="companyName"
        ...
        <div>
          <label htmlFor="regCode" className="mb-2 block text-sm font-medium text-slate-200">
            Registration code
          </label>
          <input
            id="regCode"
        ...
        <div>
          <label htmlFor="vatNumber" className="mb-2 block text-sm font-medium text-slate-200">
            VAT number
          </label>
          <input
            id="vatNumber"
        ...
        <div className="md:col-span-2">
          <label htmlFor="addressLine1" className="mb-2 block text-sm font-medium text-slate-200">
            Address line 1
          </label>
          <input
            id="addressLine1"
        ...
        <div className="md:col-span-2">
          <label htmlFor="addressLine2" className="mb-2 block text-sm font-medium text-slate-200">
            Address line 2
          </label>
          <input
            id="addressLine2"
        ...
        <div>
          <label htmlFor="billingEmail" className="mb-2 block text-sm font-medium text-slate-200">
            Billing email
          </label>
          <input
            id="billingEmail"
      ...
      {state.message && (
        <p
          className={`mt-4 text-sm ${
            state.ok ? 'text-emerald-300' : 'text-red-500'
          }`}
          aria-live="polite"
        >
          {state.message}
