...
type InvoicesUpdatedToastProps = {
  visible: boolean;
  invoiceId?: string;
};

export default function InvoicesUpdatedToast({
  visible,
  invoiceId,
}: InvoicesUpdatedToastProps) {
  ...
  return (
    <div className="fixed right-4 top-4 z-50 rounded-xl border border-neutral-200 bg-white px-4 py-3 shadow-[0_14px_28px_rgba(15,23,42,0.14)] dark:border-neutral-700 dark:bg-black">
      <div className="flex items-center gap-2">
        <p className="text-sm font-medium text-slate-900 dark:text-zinc-100">Invoice updated.</p>
        {invoiceId ? (
          <Link
